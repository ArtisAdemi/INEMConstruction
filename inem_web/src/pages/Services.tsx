...
const Services: React.FC = () => {
  return (
    <div>
      ...
      <div className=" p-6 px-[8%] xl:px-[16%] bg-[#F9F9F9] w-screen flex flex-col items-center">
          ...
          {services.map((service) => (
            <div key={service.id} className="overflow-hidden relative">
              ...
              <div className="p-4 flex">
                <div className="text-yellow-500 text-4xl mb-4 w-1/3">
                  <img src={service.icon} className="w-2/3" alt="" />
                </div>
                <div className="w-2/3">
