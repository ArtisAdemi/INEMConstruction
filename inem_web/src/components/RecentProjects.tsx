...
const RecentProjects: React.FC = () => {
  ...
  return (
    <div className="text-center p-5 lg:px-[16%] bg-[#F9F9F9] flex flex-col items-center">
      <p className="text-sm text-gray-500 mt-32">WORK OF EXCELLENCE</p>
      <h1 className="text-4xl mb-5 font-bold">RECENT PROJECTS</h1>
      ...
      <button className="bg-yellow-500 hover:bg-yellow-600 text-white py-2 px-4 rounded mb-32" onClick={() => redirect("/projects")}>
        VIEW ALL PROJECTS
      </button>
    </div>
  );
