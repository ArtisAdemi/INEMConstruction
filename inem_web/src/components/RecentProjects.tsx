...
const RecentProjects: React.FC = () => {
  ...
  return (
    <div className="text-center px-[8%] xl:px-[16%] bg-[#F9F9F9] py-16 xl:py-32 flex flex-col xl:items-center">
      ...
      <button className="bg-[#FF9723] hover:opacity-80 text-white py-2 px-4 rounded mx-auto" onClick={() => redirect("/projects")}>
        VIEW ALL PROJECTS
      </button>
    </div>
  );
