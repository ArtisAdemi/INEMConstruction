...
export const Navbar: React.FC = () => {
  ...
  return (
    <div className={`navbar-wrapper w-full ${isAtTop ? "bg-[rgba(255,255,255,0)] text-white" : "bg-[rgba(255,255,255,1)]"} flex justify-between px-[8%] xl:px-[16%] py-4 transition-all duration-300`}>
      <div className="">
